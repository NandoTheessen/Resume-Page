    ...
    return (
        <div className='education-container'>
            <div className='education-item'>
                ...
                <h6 className="font-italic">Academy of Computer Science</h6>
                <p>Comprehensive Curriculum on Computer Science and Web Development</p>
                <ul className='education-item-list'>
                    ...
                    <li className="education-item-list-item"><span className='font-weight-bold mern'>MERN-Stack:</span> React, Node, Express & mongoDB</li>
