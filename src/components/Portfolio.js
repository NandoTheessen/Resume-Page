    ...
    return (
        <div className='portfolio row' >
            <div className="project">
                <Link target="_blank" className='image-link' to='https://cocky-perlman-0a91d4.netlify.com'><img className='project-screen' src={require('../pics/notes.jpg')} alt="notes app login screen" /></Link>
